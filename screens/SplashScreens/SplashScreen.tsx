      ...
      >
        <View key="1" style={[styles.page, { backgroundColor: colors.background }]}>
          ...
          <Text style={styles.subtitle}>
            Här kan du skapa egna hushåll där du kan bjuda in medlemmar,skapa sysslor som 
          alla kan ta del av och se en statistisk resulatet av dom slutförda sysslorna.   
          </Text>
        </View>
        <View key="2" style={[styles.page, { backgroundColor: colors.background }]}>
          ...
          <Text style={styles.subtitle}>Ni kan lagra era hushåll samt sysslor på en online databas. 
          </Text>
        </View>
        ...
        <View key="4" style={[styles.page, { backgroundColor: colors.background }]}>
          ...
          <Text style={styles.subtitle}>Börja med att logga in eller om du inte har gjort
           det innan ,registrera ett nytt konto !
          </Text>
