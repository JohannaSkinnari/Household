      ...
      <PagerView style={styles.pagerView} initialPage={0}>
        ...
        >
          ...
          <Text style={[styles.subtitle, { color: colors.text }]}>
            Skapa egna hushåll, gå med i hushåll, bjud in medlemmar, skapa
            sysslor som alla kan ta en del av och i slutändan få en statistisk
            övervy av dom slutförda sysslorna.
          </Text>
        ...
        >
          ...
          <Text style={[styles.subtitle, { color: colors.text }]}>
            Ni kan tryggt lagra era hushåll och sysslor på en online databas för
            att dela dom med era medlemar.
          </Text>
        </View>
        <View
          key="3"
        ...
        >
          ...
          <Text style={[styles.subtitle, { color: colors.text }]}>
            Ni kan använda appen bekvämt om natten med med en DarkMode
        ...
        >
          ...
          <Text style={[styles.subtitle, { color: colors.text }]}>
            Börja med att logga in med dina inloggnings uppgifter !
          </Text>
          <TouchableWithoutFeedback
            onPress={async () => {
              navigation.navigate("Login");
